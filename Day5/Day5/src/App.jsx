...
const LazyContacts = lazy(() => import("./pages/user/Contacts"))
  ...
  return (
    <LazyUserMain>
      <Routes>
        ...
        <Route path="/project6/user/Contacts" element={<LazySuspense component={LazyContacts}/>}/>
        <Route path="/project6/user/ItemCard" element={<LazySuspense component={LazyItemCard}/>}/>
        <Route path="/project6/user/TermsandConditions" element={<LazySuspense component={LazyTermsandConditions}/>}/>
      </Routes>
    </LazyUserMain>
  )
}
...
const AdminRoutes = () => {
  return (
    <LazyAdminMain>
      <Routes>
        <Route path="/project6/admin/Dashboard" element={<LazySuspense component={LazyDashboard}/>}/>
      </Routes>
    </LazyAdminMain>
  )
}
