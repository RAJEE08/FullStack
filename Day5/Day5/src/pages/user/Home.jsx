...
import imageUrl from "../../assets/images/ss.jpg";
...
const Home = ({ children }) => {
    ...
    return (
            ...
            <div className="row">
              <div className="col-7 details">
                ...
                <div className="box">
                  ...
                  <ul>
                    <li>
                    <a href="/project6/user/ItemCard"><div className='card1'><img src={Card1} />
                      <p className='hellojs'>Best Sellers</p></div></a></li>
                      <li>
                      <div className='card2'><img src={Card2} />
                      <p className='hellojs'>Wedding</p></div></li>
                      <li>
                      <div className='card3'><img src={Card3} />
                      <p className='hellojs'>Birthday</p></div></li>
                      <li>
                      <div className='card4'><img src={Card4} />
                      <p className='hellojs'>Resin Art</p></div></li>
                  </ul>
              </div>
            </div>
          </section>
      ...
      <div className="image-container">
        <img src={board} alt="Portrait Image 1" className="boardimg" />
        <img src={tshirt} alt="Portrait Image 1" className="tshirtimg" />
        <img src={note} alt="Portrait Image 1" className="noteimg" />
      </div>
    </div>
